...
def setup_product():
    ...
    # Load the ZCML configuration for the collective.atomsyndication package.
    # This can of course use <include /> to include other packages.
    
    fiveconfigure.debug_mode = True
    import collective.atomsyndication
    zcml.load_config('configure.zcml', collective.atomsyndication)
...
setup_product()
#ptc.setupPloneSite(products=['collective.atomsyndication'])
ptc.setupPloneSite()
