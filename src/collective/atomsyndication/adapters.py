...
from collective.atomsyndication.interfaces import IFeed
from collective.atomsyndication.interfaces import IFeedItem
from collective.atomsyndication.interfaces import ISearchFeed
